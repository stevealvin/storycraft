  ...
  <div class="space-y-6">
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div v-for="chap in chapters" :key="chap.id"
        ...
        <div class="space-y-2">
          <div class="flex items-center justify-between">
            <span class="font-bold text-sm text-indigo-300">? {{ chap.chapter_num }} ?:{{ chap.title }}</span>
          ...
          <div>
            <label class="block text-[11px] font-medium text-slate-500 mb-1">??????</label>
        ...
        <div class="flex items-center justify-between pt-2 border-t border-slate-900 text-xs">
          <span class="text-slate-500 font-mono">??: {{ chap.word_count || 0 }} ?</span>
